...
const Navbar: React.FC = () => {
  ...
  const socialIcon1 = darkMode
    ? "/images/redditBranco.png"
    : "/images/social1.png";
  const socialIcon2 = darkMode
    ? "/images/linkedinBranco.png"
    : "/images/social2.png";
    ...
    <nav className="nav-container">
      ...
      <ul className="socialMedia">
        ...
        <li>
          <a
            className="logo"
            href="https://www.linkedin.com/in/jo%C3%A3o-victor-espindola/"
          >
